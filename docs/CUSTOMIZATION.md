...
npx jarvis set-agent-secret GH_TOKEN ghp_xxx
npx jarvis set-agent-secret ANTHROPIC_API_KEY sk-ant-xxx

# Accessible to LLM (not filtered) — set via CLI:
npx jarvis set-agent-llm-secret BROWSER_PASSWORD mypass123
```
